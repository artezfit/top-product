const products = [
  ...
  },
  {
    ...
    description: "Если нет 20% от Молочного мира, то берем этот, тоже топ за свои деньги",
    proteins: 31.2,
    fats: 18.2,
    carbs: 0,
    calories: 288.6
...
description: "Отличный способ добирать белок. Есть вариант без лактозы, но вкус клубника-арбуз мне не зашел. Я предпочитаю чернику-землянику",
proteins: 12,
fats: 0,
carbs: 2.5,
calories: 60
...
description: "Довольно вкусные и относительно недорогие. Найти можно на вб и озоне",
proteins: 32,
fats: 13,
carbs: 14,
calories: 360
